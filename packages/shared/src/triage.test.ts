...
test("matching ignores unavailable sites", () => {
  const facilities = [{ id: "1", name: "Near", type: "PHC", distanceKm: 1, services: ["PRIMARY_CARE"], available: false }, { id: "2", name: "Ready", type: "PHC", distanceKm: 3, services: ["PRIMARY_CARE"], available: true }] as Facility[];
